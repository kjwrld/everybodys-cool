...
const missionPhoto = "/images/a1e8c518674ff70fe2a6bd01e9bff360c1ad6205.webp";
...
const services = [
    {
        ...
        description:
            "Students experience immediate breakthroughs in confidence and authentic leadership presence. We believe every student possesses natural leadership qualities - our assembly unlocks those abilities in one powerful session.",
        features: [
            "30-minute whole-school leadership assembly",
            "Immediate moral courage activation",
            "Single-session confidence breakthrough experience",
            "Walk-away tools for authentic peer leadership",
        ],
    },
    {
        ...
        description:
            "Students experience breakthrough moments in self-regulation and conscious decision-making. We believe each student can actively choose their thoughts, emotions, and behavioral responses - our training delivers those life skills in one session.",
        features: [
            "60-minute private classroom intensive",
            "Immediate delayed gratification skill mastery",
            "Personalized cognitive restructuring experience",
            "Walk-away tools for decision power mastery",
        ],
    },
    {
        ...
        description:
            "Students master critical analysis and strategic reading techniques required for selective admissions. We believe every student can read at grade level and beyond - our intensive delivers those skills in one focused session.",
        features: [
            "90-minute afterschool reading intensive",
            "Competitive high school readiness focus",
            "Advanced comprehension strategy mastery",
            "Walk-away tools for selective school preparation",
        ],
    },
];
...
export function ServicesSection() {
    ...
    return (
        <section
            className="relative bg-white py-20 lg:py-24 overflow-hidden"
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-col">
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold mb-6 md:mb-6 md:order-3 leading-tight relative z-10">
                            <span
                                className={`block chroma-text-gray ${
                                    isVisible ? "chroma-text-gray-animate" : ""
                                }`}
                            >
                                Turn Every Student Into a
                            </span>
                            <span
                                className={`block chroma-text ${
                                    isVisible ? "chroma-text-animate" : ""
                                }`}
                            >
                                Confident Leader
                            </span>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-8 relative z-10">
                        <div
                            className={`flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-2 sm:px-3 sm:py-1 rounded-full border border-emerald-200 w-full sm:w-auto justify-center ${
                                isVisible
                        ...
                        <div
                            className={`flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 sm:px-3 sm:py-1 rounded-full border border-blue-200 w-full sm:w-auto justify-center ${
                                isVisible
                        ...
                        >
                            ...
                            <span className="text-sm sm:text-xs font-medium">
                                50,000+ Students Transformed
                            </span>
                        </div>
                        <div
                            className={`flex items-center gap-2 bg-amber-50 text-amber-700 px-4 py-2 sm:px-3 sm:py-1 rounded-full border border-amber-200 w-full sm:w-auto justify-center ${
                                isVisible
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 shadow-xl mb-6 relative z-10">
                        <p className="text-l text-gray-700 leading-relaxed mb-4">
                            <strong className="text-[#185CFC]">
                                Every student succeeds.
                            </strong>{" "}
                            Refined over decades of trial and error, we've built
                            a transformative curriculum to transform every child
                            in your classroom into a confident, courageous
                            leader ready to succeed to their heart's content.
                        </p>
                        ...
                        <div className="pt-4 border-t border-gray-200 text-center">
                            ...
                            <p className="text-sm text-gray-600 italic">
                                "Every one of my students showed an immediate
                                shift after listening to Kymm speak!"
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="inline-flex items-center gap-6 bg-white/95 backdrop-blur-sm px-8 py-5 rounded-2xl border border-gray-200/60 shadow-xl relative z-10 max-w-md">
                        ...
                        <div className="flex-shrink-0">
                            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100">
                                <img
                                    src="/images/ousdlogo.webp"
                                    alt="Oakland Unified School District Logo"
                    ...
                    {services.map((service, index) => {
                        ...
                        const cardThemes = [
                            // Notebook Paper Theme (Leadership) - Brand Blue Accent
                            {
                                ...
                                iconColor:
                                    "text-[#185CFC] group-hover:text-white",
                            },
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    boxShadow:
                                        "0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",
                                }}
                                {...(index === 0 && {
                                    "data-service-card": "leadership",
                                })}
                            >
                                {/* School Pattern Overlays */}
                                <div
                                    className={`absolute inset-0 ${theme.patternClass} opacity-20 pointer-events-none`}
                                />

                                <div className="relative z-10 pl-2">
                                    {/* Fun Icon with School-Themed Styling */}
                                    <div
                                        className={`w-20 h-20 ${theme.iconBg} ${theme.iconColor} rounded-2xl flex items-center justify-center transition-all duration-300 mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-6 relative overflow-hidden`}
                                    >
                                        {/* Icon sparkle effect */}
                                        ...
                                        {service.features.map(
                                            (feature, featureIndex) => (
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className={`w-4 h-4 rounded-md border-2 flex-shrink-0 transition-all duration-300 group-hover:scale-110 ${
                                                            isChalkboard
